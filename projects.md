...
- Incorporated complex survey design and applied in National Comorbidity Survey (NCS-R).
...
[**Aligning With Schools To Help Manage Asthma (peer review paper)**](https://doi.org/10.1080/02770903.2020.1864823) <span style="background-color: #aec7e8">`clinical trial`</span> <span style="background-color: #c5b0d5">`logitudinal`</span>
...
[**Timing of the definitive procedure and ileostomy closure for total colonic aganglionosis HD (peer review paper)**](https://doi.org/10.1016/j.jpedsurg.2020.02.007) <span style="background-color: #ff9896">`meta analysis`</span> 

[**Predictive Model for Operative Intervention following Blunt Abdominal Trauma in Children (peer review paper)**](https://doi.org/10.1016/j.jss.2020.05.088) <span style="background-color: #c5b0d5">`retrospective`</span>
...
[**Disease modifying effect in Alzheimer’s disease with cholinesterase inhibitors (peer review paper)**](https://doi.org/10.1016/j.ebiom.2020.102892) <span style="background-color: #c5b0d5">`prospective`</span> <span style="background-color: #9edae5">`animial experiment`</span> 
...
[**Percutaneous vs. Open Access for Extracorporeal Membrane Oxygenation in Pediatric Respiratory Failure (peer review paper)**](https://doi.org/10.1097/PCC.0000000000001691) <span style="background-color: #c5b0d5">`retrospective`</span> 
...
[**Salivary metals, age, and gender correlate with cultivable oral Candida carriage levels (peer review paper)**](https://doi.org/10.1080/20002297.2018.1447216) <span style="background-color: #dbdb8d">`cross-sectional`</span>
...
[**Revised Trauma Score using Shock Index, Peripheral Oxygen Saturation: Data from National Trauma Databank (peer review paper)**](https://doi.org/10.1016/j.surg.2019.12.003) <span style="background-color: #c5b0d5">`retrospective`</span> 
...
[**Immunization study for a candidate vaccine antigen against *Moraxella catarrhalis* (peer review paper)**](https://doi.org/10.1128/IAI.00652-17) <span style="background-color: #9edae5">`preclinical`</span> 
...
[**Minimally Invasive Surgery in Trauma (Data from National Trauma Data Bank) (peer review paper)**](https://doi.org/10.1089/lap.2019.0322) <span style="background-color: #c5b0d5">`retrospective`</span>
...
[**Analysis of the Source of Autoreactive IgM in Sjögren’s Syndrome (peer review paper)**](https://dx.doi.org/10.1189%2Fjlb.2A0715-297R) <span style="background-color: #98df8a">`bioinformatics`</span> 
...
[**Air pollution and emergency department visits for asthma in Erie County, 2007-2012 (peer review paper)**](https://doi.org/10.1007/s00420-017-1270-7) <span style="background-color: #f7b6d2">`power`</span> 
...
[**Language impairment for bilingual (peer review paper)**](https://doi.org/10.1017/S0142716415000521) <span style="background-color: #dbdb8d">`cross-sectional`</span> 
...
[**The complexity of the Spanish subjunctive in bilingual children (peer review paper)**](https://dx.doi.org/10.1080%2F10489223.2016.1192636) <span style="background-color: #dbdb8d">`cross-sectional`</span> 
